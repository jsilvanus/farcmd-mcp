...
export class SqliteAuthStore implements AuthStore, WebSessionStore {
  ...
  constructor(path:string){
    ...
    this.db.exec(
      ...
      'CREATE TABLE IF NOT EXISTS commands (id TEXT PRIMARY KEY,user_id TEXT NOT NULL,target_id TEXT NOT NULL,name TEXT NOT NULL,description TEXT NOT NULL,shell_command TEXT NOT NULL,type TEXT NOT NULL DEFAULT 'shell',content TEXT NOT NULL DEFAULT '',level INTEGER NOT NULL CHECK(level BETWEEN 1 AND 5),enabled INTEGER NOT NULL DEFAULT 1,execution_password_hash TEXT,created_at INTEGER NOT NULL,updated_at INTEGER NOT NULL);' +

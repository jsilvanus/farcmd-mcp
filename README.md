...
- **Master keys** can be generated in the SSH page or uploaded by the human. Generated Ed25519 keys may be passphrase-protected or phraseless; uploaded OpenSSH keys may likewise be passphrase-protected or phraseless. The private key is encrypted at rest; a passphrase is kept only in short-lived process memory after an explicit web-UI unlock.
